...
pub fn common_commission_sol_swap_v2<
    'info,
    T: CommonSwapProcessor<'info>,
    U: CommonCommissionProcessorV2<'info>,
>(
    swap_processor: &T,
    ...
    // 2. Commission SOL
    commission_processor.commission_sol_process_v2(
        amount_in,
        amount_out,
        expect_amount_out,
        commission_rate,
...
pub fn common_commission_token_swap_v2<
    'info,
    T: CommonSwapProcessor<'info>,
    U: CommonCommissionProcessorV2<'info>,
>(
    ...
    // 2. Commission token
    commission_processor.commission_token_process_v2(
        amount_in,
        amount_out,
        expect_amount_out,
        commission_rate,
